...
class TestInterventionData:
    ...
    def test_with_scene_update_intervention(self):
        ...
        assert intervention.intervention.updated_situation_element == "突然雨が降ってきた"
    ...
    def test_with_revelation_intervention(self):
        ...
        assert intervention.intervention.revelation_content == "遠くから助けを求める声が聞こえた"
...
class TestSceneLogData:
    ...
    def test_normal_initialization(self):
        ...
        assert isinstance(scene_log.interventions_in_scene[0].intervention, SceneUpdateDetails)
