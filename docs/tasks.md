...
### **[ ] 1.2. YAML/JSONファイルハンドラ実装 (utils/file_handler.py)**
...
### **[ ] 1.4. 場面設定ファイルの読み込み (core/scene_manager.py)**
...
### **[ ] 2.1. コンテクストビルダー基本実装 (core/context_builder.py)**
...
### **[ ] 2.3. LLMアダプター基本実装 (core/llm_adapter.py)**
...
### **[ ] 3.2. シミュレーションエンジンコア実装 (core/simulation_engine.py)**
